...
// event handlers
$bus.on('OPEN_LOGIN_DIALOG', () => { if (theDialog.value) theDialog.value.open = true })
$bus.on('CLOSE_LOGIN_DIALOG', () => { if (theDialog.value) theDialog.value.open = false })
</script>
<template>
      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="hidden md:ml-6 md:flex md:space-x-8">
            ...
            <NuxtLink to="/about" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
              Projects
            </NuxtLink>
          </div>
        </div>
